...
public class AppointmentController {
    ...
    public AppointmentController(AppointmentService appointmentService, AppointmentManager appointmentManager) {
    ...
    public ResponseEntity<?> getAppointmentById(@PathVariable("id") Long id) {
        return new ResponseEntity<>(appointmentService.findAppointmentByIdDto(id), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> getAppointmentByTeamId(@PathVariable("teamId") Long teamId) {
        try{
            return new ResponseEntity<>(appointmentService.findAppointmentsByTeamId(teamId), HttpStatus.OK);
        }catch (Exception e){
            return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
        }
    }
